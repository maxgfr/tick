...
- Countdown: multiple simultaneous timers, an appliance-style keypad (digits
  ...
  durations used — each keeping the label it was started with, each removable —
  preset chips seeded with the everyday ones
  ...
  a timer is what records its duration and its name.
